...
app.get('/api/project/team/:id', projectCtrl.getProjectTeam)
// app.get('/api/')
app.post('/api/project/create', projectCtrl.createProject)
app.post('/api/project/invite/:project_id', projectCtrl.addUsersToProject)
...
app.delete('/api/project/:project_id/:project_creator_id', projectCtrl.deleteProject)
